<script>
	const OPENGRAPH = {
		title: 'Setler',
		description: 'Setler: Identity Wallet',
		keywords: 'kudos, setler, open source, funding, developer, dev, identity wallet, dids',
		siteName: 'Setler.App',
		shareImage: `https://www.setler.app/share.png`
	};
