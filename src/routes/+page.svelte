...
{#if modal === 'seed'}
<Modal bind:open={modalOpen} ariaLabelledBy="modal" class="top-8 bg-gray-50 pl-4 pt-5 pb-4 pr-8 shadow-xl sm:p-6">
  <div class="bg-white sm:rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        <p class="mt-4 text-4xl font-bold tracking-tight text-gray-900">Important!</p>
          <h3 class="text-lg font-medium leading-6 text-gray-900 my-8">
      These words are called your recovery phrase. Please write them down on paper in the order shown and store them in a safe place. We recommend against using an online or cloud-based service to store your recovery phrase.      
      </h3>
      <div class="mt-2 max-w-xl text-sm text-gray-500 m-auto">
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-red-800">
                If you lose your recovery phrase, you will lose access to your wallet which contains your identity and may result in financial loss. 
      ...
      <dl
      class="mt-10 grid grid-cols-6 gap-y-10 gap-x-8 text-sm"
    >
...
<dd class="inline-flex items-center ">
    ...
    <div class="bg-gray-100 rounded-full text-black font-mono justify-center m-auto px-2">
 {word}
 </div>
        </dd>
    {/each}
      ...
      <div class="mt-12">
        ...
        type="button" disabled={disabledModalSubmit} class="inline-flex items-center rounded-full border border-white bg-red-800 px-4 py-2 font-medium text-white shadow-sm hover:bg-red-500 focus:outline-none focus:ring-0 focus:ring-offset-2 sm:text-sm disabled:bg-red-200">I have written these down</button>
      </div>
    </div>
  </div>
