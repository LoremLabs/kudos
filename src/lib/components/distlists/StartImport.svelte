  ...
  <div class="px-4 py-5 sm:p-6">
    <div>
      ...
      <div class="mt-1 text-sm text-gray-500">
        After importing, you can send money to your distribution, or you can
        recognize them publicly for their work by publishing.
      </div>
      <div class="text-right">
        <button
          class="cursor-pointer text-sm font-medium text-cyan-800 underline hover:text-cyan-700"
          on:click={() => {
            goto('https://www.loremlabs.com/');
          }}
        >
          <Icon name="information-circle" class="inline h-4 w-4" />
          More on Kudos<Icon
            name="external-link"
