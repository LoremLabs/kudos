...
{/if}
{#if ready}
<nav class="bg-slate-900 overflow-visible">
    <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        <div class="flex items-center px-2 lg:px-0">
          <div class="flex-shrink-0">
            <h2 class="text-center text-lg font-bold tracking-tight text-gray-50">My Identity</h2>
        </div>
        </div>
        <div class="">
          <div class="flex items-center">
            ...
            <div class="relative ml-4 flex-shrink-0">
              ...
              -->
              <div class="hidden absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-red-100 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
