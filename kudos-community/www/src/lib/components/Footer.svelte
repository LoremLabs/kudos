...
<footer class="bg-tertiary border-t-2" aria-labelledby="footer-heading">
	<h2 id="footer-heading" class="sr-only">Footer</h2>
	<div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			<img class="h-12" src="/svg/kudos-logo-02.svg" alt="Kudos" />
			<div class="mt-16">
				<h3 class="text-sm font-semibold leading-6 text-gray-900">Kudos Supporters</h3>
				<ul role="list" class="mt-6 space-y-4">
					<li>
						<a
							href="https://www.loremlabs.com"
							class="text-sm leading-6 text-gray-600 hover:text-gray-900">Lorem Labs</a
						>
					</li>
				</ul>
			</div>
			<div class="mt-16 hidden zgrid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
		...
		{/if}
		<div
			class="mt-8 border-t border-gray-900/10 pt-8 hidden md:flexz md:items-center md:justify-between"
		>
			...
			<p class="hidden mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
				&copy; 2023 Lorem Industries, Inc. All rights reserved.
			</p>
		</div>
	</div>
</footer>
